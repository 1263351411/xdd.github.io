...
1. 使用**隐试内连接查询**10010员工所在部门编号及员工信息
    ...
    * 对应的sql语句为：
    ...
    ![sqlalchemy_021](../../../img/python/sqlalchemy_021.jpg)  
...
2. **使用join查询**
    ...
    ![sqlalchemy_023](../../../img/python/sqlalchemy_023.jpg)  
...
3. **使用left join查询**
    ...
    ![sqlalchemy_024](../../../img/python/sqlalchemy_024.jpg)  
...
![sqlalchemy_022](../../../img/python/sqlalchemy_022.jpg)  
...
* 查询10010员工的所在部门编号及员工信息
    ...
    ![sqlalchemy_025](../../../img/python/sqlalchemy_025.jpg)  
