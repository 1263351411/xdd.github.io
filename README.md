...
4. [封装和解构及特殊变量](python基本知识/封装和解构及特殊变量.md)   
5. [set和集合运算](python基本知识/set和集合运算.md)  
6. [dict字典](python基本知识/dict字典.md) 
7. [解析式和生成器表达式](python基本知识/解析式和生成器表达式.md)
8. [datetime时间模块的使用](python基本知识/datetime时间模块的使用.md)  
9. [内建函数和可迭代对象，迭代器](python基本知识/内建函数和可迭代对象，迭代器.md) 
