...
* 传统的生产者和消费者模型  
![log002](https://raw.githubusercontent.com/1263351411/xdd.github.io/master/img/python/log002.png)    
...
* 带入消息队列的生产者和消费者模型
* 作用——解耦、缓冲。   
![log003](https://raw.githubusercontent.com/1263351411/xdd.github.io/master/img/python/log003.png)   
...
![log004](https://raw.githubusercontent.com/1263351411/xdd.github.io/master/img/python/log004.png)   
### 分发器的实现
数据分析的程序有很多，例如PV分析、IP分析、UserAgent分析等。  
同一套数据可能要被多个分析程序并行处理：  
* 需要使用多线程来并行处理
* 多个分析程序又需要同一份数据，这就是一份变多份  
![log005](https://raw.githubusercontent.com/1263351411/xdd.github.io/master/img/python/log005.png)   
这是一个典型的分发器
